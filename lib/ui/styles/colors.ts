...
const Colors = {
  light: {
    luvabranca: {
      primary: '#FF3B7C',
      onPrimary: '#FFFFFF',
      primaryContainer: '#FFD6E5',
      onPrimaryContainer: '#222222',
      secondary: '#F9F9F9',
      onSecondary: '#222222',
      secondaryContainer: '#FFECEC',
      onSecondaryContainer: '#222222',
      tertiary: '#666666',
      onTertiary: '#FFFFFF',
      tertiaryContainer: '#CCCCCC',
      onTertiaryContainer: '#222222',
      error: '#EA5455',
      onError: '#FFFFFF',
      errorContainer: '#FFEBEB',
      onErrorContainer: '#EA5455',
      background: '#FFFFFF',
      onBackground: '#222222',
      surface: '#F9F9F9',
      onSurface: '#222222',
      surfaceVariant: '#FFECEC',
      onSurfaceVariant: '#666666',
      outline: '#CCCCCC',
      outlineVariant: '#FFD6E5',
      shadow: '#000000',
      scrim: '#000000',
      inverseSurface: '#222222',
      inverseOnSurface: '#F9F9F9',
      inversePrimary: '#FFD6E5',
      elevation: {
        level0: 'transparent',
        level1: '#FEFEFE',
        level2: '#FDFDFD',
      ...
      onSuccessContainer: '#28C76F',
      warning: '#F5A623',
      onWarning: '#FFFFFF',
      warningContainer: '#FFF3E0',
      onWarningContainer: '#F5A623',
      textPrimary: '#222222',
  ...
  dark: {
    luvabranca: {
      primary: '#FF6B9D',
      onPrimary: '#1A1A1A',
      primaryContainer: '#2D1A23',
      onPrimaryContainer: '#FFD6E5',
      secondary: '#2A2A2A',
      onSecondary: '#FFFFFF',
      ...
      outline: '#444444',
      outlineVariant: '#2D1A23',
      shadow: '#000000',
      scrim: '#000000',
      inverseSurface: '#FFFFFF',
      inverseOnSurface: '#1A1A1A',
      inversePrimary: '#FF3B7C',
      elevation: {
        level0: 'transparent',
        level1: '#212121',
        level2: '#242424',
      ...
      onSuccessContainer: '#A8E6A3',
      warning: '#FFC107',
      onWarning: '#1A1A1A',
      warningContainer: '#3D3A1B',
